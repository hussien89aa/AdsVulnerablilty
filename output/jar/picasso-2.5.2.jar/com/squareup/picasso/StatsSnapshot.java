...
public class StatsSnapshot {
    ...
    public void dump() {
        ...
        this.dump(new PrintWriter(logWriter));
        Log.i((String)"Picasso", (String)logWriter.toString());
    }
    ...
    public void dump(PrintWriter writer) {
        ...
        writer.println((int)Math.ceil((float)this.size / (float)this.maxSize * 100.0f));
